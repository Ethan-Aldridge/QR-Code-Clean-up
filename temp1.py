...
# out_path = "all\\all_processed\\" + img_name
...
for filename in os.listdir("all\\all_processed\\"):
    if filename.lower().endswith((".png",".jpg")):
        img_names.append(os.path.join("all","all_processed", filename))
        out_names.append(os.path.join("all","rotated", filename))
